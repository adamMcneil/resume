...
\entry{NISC}
  ...
  {}
  {
  - Developed and implemented code for custom batch process. \newline
...
\entry{UDP Controller}
  ...
  {}
  {
    Created phone app that communicates with a local game server using a UDP web socket protocol to handle game movement.
  }
...
\entry{Lichess Engine}
  ...
  {https://github.com/Babymcnerd/Chess-Engine }
  {
    ...
    It used a minimax algorithm with alpha beta pruning to select the best move.
  }
  {Java, Lichess \newline}
