...
\textbf{Profile} &
{
  ...
  In my graduate studies I emphasised in distributed systems and database systems.
...
\entry{Streaming Platform}
  ...
  {}
  {
  - Developed a membership prodigal \newline
  - Developed a fault-tolerant Distributed File System \newline
  - Developed a fault-tolerant streaming \newline
  - Designed and developed the a membership protical \newline
  - Develeped a  \newline
  - 
  }
  {Go, Protocol Buffers, gRPC, Git, Docker, Spark Streaming, Distributed Systems, TCP, UDP\newline}
