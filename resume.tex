...
\textbf{Profile} &
{
  ...
  I have experience as a backend developer with technologies such as Java, SQL, and Git.
  And also experience as a full-stack developer using React and Svelte.
...
\timeFrame{2025}{Now}{} &
  ...
  {}
  {
  - Developed React that integrated with Dynamics 365 backend. \newline
  ...
  {JavaScript, Git, React, Full-Stack, Azure Pipelines, CI/CD, Grafana \newline}
% NISC 
